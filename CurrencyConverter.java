...
public class CurrencyConverter extends JFrame {
	...
	public CurrencyConverter() {
		...
		fromtext.setModel(new DefaultComboBoxModel(new String[] {"INR", "USD", "EURO", "YEN", "POUND", "PESO", "YUAN"}));
		...
		totext.setModel(new DefaultComboBoxModel(new String[] {"INR", "USD", "EURO", "YEN", "POUND", "PESO", "YUAN"}));
